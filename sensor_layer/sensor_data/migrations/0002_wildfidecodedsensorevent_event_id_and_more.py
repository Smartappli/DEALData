...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='wildfidecodedsensorevent',
            constraint=models.UniqueConstraint(condition=models.Q(('event_id', ''), _negated=True), fields=('source', 'event_id'), name='uq_wildfi_sensor_source_event_id'),
        ),
        migrations.AddConstraint(
            model_name='wildfidecodedsensorevent',
            constraint=models.UniqueConstraint(condition=models.Q(('payload_hash', ''), _negated=True), fields=('source', 'payload_hash'), name='uq_wildfi_sensor_source_payload_hash'),
        ),
    ]
